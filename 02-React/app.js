...
/* 
this react is comming from node_modules 
*/
...
/* const parent = React.createElement(
    'div',
    { id: 'parent' },
    [React.createElement('div', {key: 'child-1', id: 'child' }, [
        React.createElement('h1', {key: 'h1'}, 'H1 tag changed'),
        React.createElement('h2', {key: 'h2'}, 'h2 tag')
    ]), React.createElement('div', {key: 'child-2', id: 'child2' }, [
        React.createElement('h1', {key: 'h3'}, 'H1 tag'),
        React.createElement('h2', {key: 'h4'}, 'h2 tag')
    ])]
);
const root = ReactDOM.createRoot(document.getElementById('root'));
root.render(parent) */
